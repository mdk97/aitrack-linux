...
bool QGlobalShortcut::QGlobalShortcutEventFilter::nativeEventFilter( const QByteArray &eventType,
                                                                     void *            message,
                                                                     long *            result )
{
...
{
    xcb_grab_key( QX11Info::connection(), 1, QX11Info::appRootWindow(), m, k, XCB_GRAB_MODE_ASYNC,
                  XCB_GRAB_MODE_ASYNC );
}
