...
HeadCalibrationWindow::HeadCalibrationWindow( IRootView *prev_window, QWidget *parent ) : QMainWindow( parent )
{
    ui.setupUi( this );
...
{
    view_frame->setPixmap( QPixmap::fromImage( QImage( img.data, img.cols, img.rows, img.step, QImage::Format_RGB888 ) )
