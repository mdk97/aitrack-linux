...
std::unique_ptr<TrackerWrapper> TrackerFactory::buildTracker( int          im_width,
                                                              int          im_height,
                                                              float        distance,
                                                              float        fov,
                                                              TRACKER_TYPE type,
...
TrackerFactory::TrackerFactory( std::string modeldir ) : model_dir( modeldir )
{
}
...
TRACKER_TYPE
TrackerFactory::get_type( int type )
{
